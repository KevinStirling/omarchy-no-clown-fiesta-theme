...
# Usage
When you install this theme, note that it is using `vim.pack` neovim.lua file by default. If you use LazyVim, there is a config for you in the neovim/ directory. Simply swap the files and rename for you use case. 

It's on the todo list to get an install script working to do this for you.
